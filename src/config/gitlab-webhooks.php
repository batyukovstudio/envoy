...
return [
     ...
     */
    'job' => \Batyukovstudio\Envoy\EnvoySection\Envoy\Jobs\ProcessGitLabWebhookJob::class,
     ...
     */
    'verify_signature' => env('GITLAB_SIGNATURE_VERIFY', true),
];
